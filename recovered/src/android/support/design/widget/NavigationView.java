...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        ColorStateList createDefaultColorStateList = !obtainStyledAttributes.hasValue(android.support.design.R.styleable.NavigationView_itemIconTint) ? createDefaultColorStateList(R.attr.textColorSecondary) : obtainStyledAttributes.getColorStateList(android.support.design.R.styleable.NavigationView_itemIconTint);
        if (obtainStyledAttributes.hasValue(android.support.design.R.styleable.NavigationView_itemTextAppearance)) {
            resourceId = obtainStyledAttributes.getResourceId(android.support.design.R.styleable.NavigationView_itemTextAppearance, 0);
            z = true;
        } else {
            resourceId = 0;
            z = false;
