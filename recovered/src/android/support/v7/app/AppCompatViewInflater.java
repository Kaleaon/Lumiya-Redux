...
class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        int resourceId = !z ? 0 : obtainStyledAttributes.getResourceId(android.support.v7.appcompat.R.styleable.View_android_theme, 0);
        if (z2 && resourceId == 0) {
            int resourceId2 = obtainStyledAttributes.getResourceId(android.support.v7.appcompat.R.styleable.View_theme, 0);
            if (resourceId2 == 0) {
                i = resourceId2;
            } else {
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        Context context2;
        view2 = null;
        context2 = (z && view != null) ? view.getContext() : context;
        if (z2 || z3) {
