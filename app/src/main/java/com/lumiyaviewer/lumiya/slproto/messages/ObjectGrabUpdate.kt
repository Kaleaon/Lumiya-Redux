 ...
 */
open class ObjectGrabUpdate : SLMessage() {
    ...
    open class ObjectData {
        @JvmField var GrabOffsetInitial: LLVector3? = null
        @JvmField var GrabPosition: LLVector3? = null
        @JvmField var ObjectID: UUID? = null
        @JvmField var TimeSinceLast: Int = 0
    }
    ...
    override fun Handle(messageHandler: SLMessageHandler) {
        messageHandler.HandleObjectGrabUpdate(this)
    }
