 ...
 * Reliable
 *
 * <p>Template: {@code GroupAccountTransactionsRequest Low 357 NotTrusted Zerocoded}
 * (recovered/reference/message_template.msg).
 */
open class GroupAccountTransactionsRequest : SLMessage() {
    ...
    override fun PackPayload(byteBuffer: ByteBuffer) {
        // Message number: Low 357 (GroupAccountTransactionsRequest).
