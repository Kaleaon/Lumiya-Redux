...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    private class SubRangeMap implements RangeMap<K, V> {
                ...
                Iterator<Map.Entry<Range<K>, V>> entryIterator() {
                    ...
                    return new AbstractIterator<Map.Entry<Range<K>, V>>() { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.1.1
                        ...
                        public Map.Entry<Range<K>, V> computeNext() {
                            ...
                            RangeMapEntry rangeMapEntry = (RangeMapEntry) it.next();
                            return rangeMapEntry.getUpperBound().compareTo((Cut) SubRangeMap.this.subRange.lowerBound) > 0 ? Maps.immutableEntry(rangeMapEntry.getKey().intersection(SubRangeMap.this.subRange), rangeMapEntry.getValue()) : (Map.Entry) endOfData();
                        }
                    };
                }
            };
        ...
        /* JADX WARN: Type inference failed for: r0v26, types: [com.google.common.collect.Cut] */
        @Override // com.google.common.collect.RangeMap
        public Range<K> span() {
            Cut<K> cut;
            ...
            if (floorEntry != null && ((RangeMapEntry) floorEntry.getValue()).getUpperBound().compareTo((Cut) this.subRange.lowerBound) > 0) {
                ...
                ?? r0 = (Cut) TreeRangeMap.this.entriesByLowerBound.ceilingKey(this.subRange.lowerBound);
                if (r0 == 0 || r0.compareTo(this.subRange.upperBound) >= 0) {
                    throw new NoSuchElementException();
                }
                cut = r0;
            }
            ...
            if (lowerEntry != null) {
                return Range.create(cut, ((RangeMapEntry) lowerEntry.getValue()).getUpperBound().compareTo((Cut) this.subRange.upperBound) < 0 ? ((RangeMapEntry) lowerEntry.getValue()).getUpperBound() : this.subRange.upperBound);
            }
            throw new NoSuchElementException();
        }
