...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private Drawable getThemeUpIndicator() {
        ...
        TypedArray obtainStyledAttributes2 = (actionBar == null ? this.mActivity : actionBar.getThemedContext()).obtainStyledAttributes(null, THEME_ATTRS, R.attr.actionBarStyle, 0);
