...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            ...
            ViewGroup viewGroup4 = (ViewGroup) LayoutInflater.from(typedValue.resourceId == 0 ? this.mContext : new ContextThemeWrapper(this.mContext, typedValue.resourceId)).inflate(R.layout.abc_screen_toolbar, (ViewGroup) null);
    ...
    */
    boolean onKeyUp(int r6, android.view.KeyEvent r7) {
        ...
        L5:
            return r3
        L6:
            r5.onKeyUpPanel(r3, r7)
            return r4
        La:
            boolean r0 = r5.mLongPressBackDown
            r5.mLongPressBackDown = r3
            android.support.v7.app.AppCompatDelegateImplV9$PanelFeatureState r1 = r5.getPanelState(r3, r3)
            if (r1 != 0) goto L1b
        L14:
            boolean r0 = r5.onBackPressed()
            if (r0 == 0) goto L5
            return r4
        L1b:
        ...
        L22:
            ...
            goto L21
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.app.AppCompatDelegateImplV9.onKeyUp(int, android.view.KeyEvent):boolean");
    }
