...
class IntKeyframeSet extends KeyframeSet {
    ...
    /* renamed from: clone */
    public IntKeyframeSet mo919clone() {
        ArrayList<Keyframe> arrayList = this.mKeyframes;
        int size = this.mKeyframes.size();
        Keyframe.IntKeyframe[] intKeyframeArr = new Keyframe.IntKeyframe[size];
        for (int i = 0; i < size; i++) {
            intKeyframeArr[i] = (Keyframe.IntKeyframe) arrayList.get(i).mo920clone();
        }
    ...
    public int getIntValue(float f) {
        ...
        while (true) {
            ...
            if (f < intKeyframe5.getFraction()) {
                ...
                return this.mEvaluator != null ? ((Number) this.mEvaluator.evaluate(fraction5, Integer.valueOf(intValue5), Integer.valueOf(intKeyframe5.getIntValue()))).intValue() : ((int) ((r0 - intValue5) * fraction5)) + intValue5;
            }
            i++;
        }
    }
