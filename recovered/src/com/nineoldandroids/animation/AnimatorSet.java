...
public final class AnimatorSet extends Animator {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m918clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo917clone();
                return node;
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo917clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo917clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m918clone = next.m918clone();
            hashMap.put(next, m918clone);
            animatorSet.mNodes.add(m918clone);
            animatorSet.mNodeMap.put(m918clone.animation, m918clone);
            m918clone.dependencies = null;
            m918clone.tmpDependencies = null;
            m918clone.nodeDependents = null;
            m918clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m918clone.animation.getListeners();
            if (listeners != null) {
