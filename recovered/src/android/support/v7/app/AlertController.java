...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                listAdapter = this.mCursor != null ? new CursorAdapter(this.mContext, this.mCursor, z) { // from class: android.support.v7.app.AlertController.AlertParams.2
                ...
                } : new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, i, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
                ...
                int i2 = !this.mIsSingleChoice ? alertController.mListItemLayout : alertController.mSingleChoiceItemLayout;
                listAdapter = this.mCursor == null ? this.mAdapter == null ? new CheckedItemAdapter(this.mContext, i2, R.id.text1, this.mItems) : this.mAdapter : new SimpleCursorAdapter(this.mContext, i2, this.mCursor, new String[]{this.mLabelColumn}, new int[]{R.id.text1});
            }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        final View findViewById2 = this.mWindow.findViewById(android.support.v7.appcompat.R.id.scrollIndicatorDown);
    ...
    private void setupView() {
        ...
        if (!z3 && resolvePanel2 != null && (findViewById = resolvePanel2.findViewById(android.support.v7.appcompat.R.id.textSpacerNoButtons)) != null) {
        ...
        } else if (resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(android.support.v7.appcompat.R.id.textSpacerNoTitle)) != null) {
