...
public abstract class UserFunctionsFragment extends ChatterReloadableFragment implements ReloadableFragment {
    ...
    private /* synthetic */ int[] f378xb1d54699 = null;
    ...
    private /* synthetic */ int[] m569x2680ba3d() {
    ...
    private void handleUserMute(final ChatterID chatterID) {
        ...
        String resolvedNameOrLoading = this.nameRetriever != null ? this.nameRetriever.getResolvedName() : null;
        if (resolvedNameOrLoading == null) {
            resolvedNameOrLoading = getString(R.string.name_loading_title);
        }
        final String resolvedName = resolvedNameOrLoading;
