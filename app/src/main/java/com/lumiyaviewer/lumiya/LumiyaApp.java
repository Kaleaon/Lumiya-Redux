...
public class LumiyaApp extends Application {
    ...
    public static void restartApp() {
        ((AlarmManager) getContext().getSystemService(NotificationCompat.CATEGORY_ALARM)).set(1, System.currentTimeMillis() + 1000, PlatformCompat.getActivity(getContext(), 0, new Intent(getContext(), LoginActivity.class), PendingIntent.FLAG_CANCEL_CURRENT));
        System.exit(0);
    }
